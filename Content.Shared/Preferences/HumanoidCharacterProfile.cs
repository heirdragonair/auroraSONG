...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile
    {
        ...
        /// <summary>
        /// DEN - Detailed text that can appear for the character if <see cref="CCVars.FlavorText"/> is enabled and the consent is on.
        /// </summary>
        [DataField]
        public string NsfwFlavorText { get; set; } = string.Empty;

        /// <summary>
        /// DEN - A consent sheet, adds onto your original for this character specifically.
        /// </summary>
        [DataField]
        ...
        public void EnsureValid(ICommonSession session, IDependencyCollection collection)
        {
            ...
            if (configManager.GetCVar(CCVars.RestrictedNames) && speciesPrototype.ID != "IPC") // Aurora - lift restrictions on ipc names.
            {
