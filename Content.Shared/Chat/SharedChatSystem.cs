...
using Content.Shared.Physics; // TheDen
...
public abstract partial class SharedChatSystem : EntitySystem
{
    ...
    // public const char RadioChannelAltPrefix = '.'; // TheDen - This is used for subtle
        ...
        out string prefix)
    {
        ...
        if (!(input.StartsWith(RadioChannelPrefix))) // TheDen - Remove RadioChannelPrefix
            return;
